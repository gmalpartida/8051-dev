...
;	ADD8B07.C:5: char var1 = 5;
	mov	_var1,#0x05
;	ADD8B07.C:6: char var2 = 6;
	mov	_var2,#0x06
;	ADD8B07.C:7: char var3 = 7;
	mov	_var3,#0x07
	.area GSFINAL (CODE)
...
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
;	ADD8B07.C:11: while (1)
00102$:
;	ADD8B07.C:13: var3 = var1 + var2;
	mov	a,_var2
	add	a,_var1
	mov	_var3,a
;	ADD8B07.C:46: __endasm;
