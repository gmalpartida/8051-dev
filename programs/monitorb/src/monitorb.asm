...
X_1:    MOV    DPL,R0   
        ...
        LJMP   GETSEL
;
$INCLUDE(src/wt_string.asm)
$INCLUDE(src/rd_char.asm)
$INCLUDE(src/wt_char.asm)
$INCLUDE(src/asc2hex.asm)
$INCLUDE(src/hex2asc.asm)
$INCLUDE(src/lfcr.asm)
$INCLUDE(src/wait.asm)
$INCLUDE(src/readhex.asm)
$INCLUDE(src/wrbyte.asm)
;
        END
